...
r=subprocess.run([gemini,'S&P 500 prediction for today. Search news/sentiment. Reply ONLY: <dir>UP or DOWN</dir><pct>NUMBER</pct><conf>LOW/MED/HIGH</conf><why>10 words max</why>'],capture_output=True,text=True,timeout=120)
