...
r=subprocess.run([gemini,'Search for recent Jensen Huang (NVIDIA CEO) quotes or insights from last 7 days. Reply ONLY: <found>YES or NO</found><quote>quote text if found</quote><context>event/interview name 10 words max</context><date>date</date>'],capture_output=True,text=True,timeout=120)
