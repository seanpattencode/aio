...
r=subprocess.run([gemini,'Motivate someone building AI agent tools. Reply ONLY: <msg>2 sentences why it matters</msg><quote>inspiring tech quote</quote><by>author</by>'],capture_output=True,text=True,timeout=240)
