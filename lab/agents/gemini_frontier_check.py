...
r=subprocess.run([gemini,'Search for new frontier AI model releases (GPT, Claude, Gemini, Llama, etc) in last 3 days. Reply ONLY: <new>YES or NO</new><model>name if new else NONE</model><company>company</company><info>key info 15 words max</info>'],capture_output=True,text=True,timeout=120)
