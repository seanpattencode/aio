...
<div id="job-menu" class="dropdown">
  <form method="POST" action="/job/run/wikipedia">
    <input type="submit" style="background:transparent;border:none;color:{fg};cursor:pointer;padding:8px;width:100%;text-align:left" value="Wikipedia Random Article">
  </form>
...
<div class="section">
<h2>RUNNING</h2>
{running_html if running_html else '<div style="color:#888;padding:10px">No running jobs</div>'}
</div>

<div class="section">
<h2>REVIEW</h2>
{review_html if review_html else '<div style="color:#888;padding:10px">No jobs in review</div>'}
</div>
